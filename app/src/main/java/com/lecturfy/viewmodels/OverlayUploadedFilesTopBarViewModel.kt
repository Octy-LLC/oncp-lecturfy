...
data class OverlayuploadedfilestopbarViewModelState (
...
@HiltViewModel
class OverlayuploadedfilestopbarViewModel @Inject constructor (
  private val savedStateHandle: SavedStateHandle,
  private val sharedPreferences: SharedPreferences,
  private val googleSignInHelper: GoogleSignInHelper,
  @ApplicationContext private val context: Context
) : ViewModel() {
  private val _state = MutableStateFlow<OverlayuploadedfilestopbarViewModelState>(OverlayuploadedfilestopbarViewModelState());
